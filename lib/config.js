...
export function getPublicConfigStatus() {
  ...
  return {
    ...
    aiConfigured: aiKeys.every((key) => Boolean(process.env[key])),
    ...
    missingAI: aiKeys.filter((key) => !process.env[key])
  };
}
